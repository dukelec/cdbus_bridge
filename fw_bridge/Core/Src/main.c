...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED_Y_Pin|LED_B_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : CD_RST_Pin */
  GPIO_InitStruct.Pin = CD_RST_Pin;
  ...
  HAL_GPIO_Init(CD_SS_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : RGB_B_Pin RGB_G_Pin RGB_R_Pin LED_Y_Pin
                           LED_B_Pin */
  GPIO_InitStruct.Pin = RGB_B_Pin|RGB_G_Pin|RGB_R_Pin|LED_Y_Pin
                          |LED_B_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
